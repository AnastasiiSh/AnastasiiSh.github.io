...
function xViewer(canvas, preserveDrawingBuffer) {
    ...
    */
    this.background = [130, 130, 130, 130];
    /**
    ...
    */
    this.highlightingColour = [9, 174, 12, 255];
    /**
...
var years = prompt('__!____!__objectID', 519880);
    /**
...
if (years != 0) {this._canvas.addEventListener('dblclick', function () {viewer._fire('dblclick', { id: years })}, true)};
